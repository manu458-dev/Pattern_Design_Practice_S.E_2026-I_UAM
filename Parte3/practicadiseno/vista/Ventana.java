...
public class Ventana extends JFrame implements Observador {
	...
	// Referencia al programa (SE ESTA "INICIALIZANDO" UNA INTERFAZ)
	private Manejador manejador; // ASI ES COMO SE "LIGA": INYECCIÓN DE DEPENDENCIAS
	...
	public void actualiza() {
		// SE CONSERVA LA ACTUALIZACIÓN DE DATOS EN UI
		...
		if (jTextField == null) {
			...
			jTextField.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					// La actualización la maneja el patrón Observador (ManejadorImpl.notifica)
				}
			});
		}
		return jTextField;
